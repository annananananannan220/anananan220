...
if not getgenv().StingrayLoaded then
    ...
    local Toggle = "ON"
    task.spawn(function()
        local UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/annananananannan220/anananan220/refs/heads/main/miauign/kakaf"))()
        ...
        if Toggle == "ON" then
            local S, E = pcall(function()
                queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/annananananannan220/anananan220/refs/heads/main/miauign/kakafi.lua"))()')()
            end)
        end
    end)

    -- Constants
    local Domainable = {"Ocean Curse","Soul Curse","Heian Imaginary Demon"} -- I removed jogo since apparently domaining him glitches
    local LuckTable = {
        Cats = {
    ...
    local function AnalyseInventory() -- I use British spelling haha what u gonna do about it :nerd:
    ...
    task.spawn(function()
        ...
        local S,E = pcall(function()
            ...
            local Data = game:GetService("HttpService"):JSONEncode({
                Key = "{KEY}",
                Username = "Just Want to use your script :/",
        ...
        local S,E = pcall(function()
            ...
            print(Data)
            request({
                Url = "http://stingray-digital.online/script/boss",
                Headers = {
                    ['Content-Type'] = 'application/json'
                },
                Body = Data,
